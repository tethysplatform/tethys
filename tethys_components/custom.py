...
def Panel(props, *children):
    ...
    return lib.html.div(
        ...
        lib.html.div(
            Props(
                class_name="offcanvas-header"
            ),
            lib.html.div(
                Props(
                    class_name="offcanvas-title h5"
                ),
                name
            ),
            lib.html.button(
    ...
    return lib.html.div(
        lib.bs.Offcanvas(
            ...
            lib.bs.OffcanvasHeader(
                ...
                lib.bs.OffcanvasTitle(nav_title)
            ),
...
def HeaderWithNavBar(app, user, nav_links):
    ...
    return lib.bs.Navbar(
        ...
        lib.bs.Container(
            ...
            lib.bs.NavbarBrand(
                Props(href=f'/apps/{app.root_url}/', class_name="mx-0 d-none d-sm-block", style=Props(color="white")),
