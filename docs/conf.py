...
latex_documents = [
  ('index', 'TethysPlatform.tex', 'Tethys Platform Documentation',
   'Nathan Swain', 'manual'),
]
...
man_pages = [
    ('index', 'tethysplatform', 'Tethys Platform Documentation',
     ['Nathan Swain'], 1)
]
...
texinfo_documents = [
  ('index', 'TethysPlatform', 'Tethys Platform Documentation',
   'Nathan Swain', 'TethysPlatform', 'One line description of project.',
   'Miscellaneous'),
]
