...
.. important::
    ...
    You must have Docker installed and add your user to the ``docker`` group to use the Tethys ``docker`` command (see: `Install Docker <https://docs.docker.com/get-started/get-docker/>`_ and `Post-installation steps for Linux <https://docs.docker.com/get-started/get-docker/linux/linux-postinstall/>`_).
