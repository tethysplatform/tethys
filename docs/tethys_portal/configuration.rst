...
OAUTH2_REQUIREMENTS                                a mapping of app package to the name of a social auth provider that users must be linked to before they can access that app (e.g. ``{"my_first_app": "my_provider"}``). Users who have not linked an account are redirected to their user settings page. See :ref:`secure_map_services_oauth`.
================================================== ================================================================================
