...
* Review the documentation relevant to the way you plan to contribute, whether it's :ref:`code <contribute_intro_code>`, :ref:`documentation <contribute_intro_docs>`, or :ref:`community support <contribute_intro_community_support>`.
* Familiarize yourself with the :ref:`contribute_intro_policies` that help us maintain a welcoming and inclusive environment for all contributors.
* Introduce yourself on one or more of our :ref:`contribute_intro_communication` to connect with other contributors.
* Review the :ref:`contribute_intro_license`, which you will be required to sign during your first pull request.
* Join the Tethys Geoscience Foundation by signing up for a membership at `Tethys Geoscience Foundation <https://tethysgeoscience.org/membership/>`_.
...
.. _contribute_intro_communication:
...
* Introduce yourself on the Tethys Platform `GitHub Discussions page <https://github.com/tethysplatform/tethys/discussions>`_ in the `Contributors category <https://github.com/tethysplatform/tethys/discussions/categories/contributors>`_ to connect with other contributors.
* Join the `#tethys-platform <https://discord.gg/h3nP6z3pZn>`_ channel on the Tethys Geoscience Foundation Discord Server to chat with other contributors in real time.
* Join us for our weekly Tethys Scrum web meeting on Fridays at 1:00 pm US Mountain Time. Request a link to the meeting by emailing `<tethysplatform@tethysgeoscience.org>`_.
* Follow the Tethys Geoscience Foundation, the non-profit that supports Tethys Platform, on `LinkedIn <https://www.linkedin.com/company/tethys-geoscience-foundation>`_, `Facebook <https://www.facebook.com/profile.php?id=61566817076633>`_, and `Instagram <https://www.instagram.com/tethysgeoscience>`_ to get the latest news and updates about Tethys Platform and other Tethys Geoscience Foundation projects.

.. _contribute_intro_policies:
...
* `Code of Conduct <https://github.com/tethysplatform/tethys/blob/main/CODE_OF_CONDUCT.md>`_


.. _contribute_intro_license:

Developer Certificate of Origin
===============================

**TODO**: need input on how to proceed with this. See: `GitHub Discussion: Shall we adopt a CLA or DCO? <https://github.com/tethysplatform/tethys/discussions/1138>`_
