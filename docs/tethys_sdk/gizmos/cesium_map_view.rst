...
This method returns the Cesium ``Viewer`` instance. You can use the `Cesium.Viewer API Docs <https://cesium.com/learn/cesiumjs/ref-doc/>`_ to perform operations on this object such as changing the view, animating, and modifying the entities, layers, and models.
