...
def update_brand_image(apps, schema_editor):
    ...
    if brand_image_setting.content == "/tethys_portal/images/tethys-logo-25.png":
        brand_image_setting.content = "/tethys_portal/images/tethys-on-blue-icon-only.svg"
...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.RunPython(update_brand_image, reverse_code=reverse_update_brand_image),
    ]
