...
//
    ...
    var defaultBillboard = {
        iconUrl: "/static/tethys_gizmos/images/dragIcon.png",
        shiftX: 0,
        shiftY: 0
    }
    ...
    var dragHalfBillboard = {
        iconUrl: "/static/tethys_gizmos/images/dragIconLight.png",
        shiftX: 0,
        shiftY: 0
    }
    ...
    _.DrawHelperWidget = (function() {
        ...
        function _(drawHelper, options) {
            ...
            var drawOptions = {
                markerIcon: "/static/tethys_gizmos/images/glyphicons_242_google_maps.png",
                polylineIcon: "/static/tethys_gizmos/images/glyphicons_097_vector_path_line.png",
                polygonIcon: "/static/tethys_gizmos/images/glyphicons_096_vector_path_polygon.png",
                circleIcon: "/static/tethys_gizmos/images/glyphicons_095_vector_path_circle.png",
                extentIcon: "/static/tethys_gizmos/images/glyphicons_094_vector_path_square.png",
                clearIcon: "/static/tethys_gizmos/images/glyphicons_067_cleaning.png",
                logoffIcon: "/static/tethys_gizmos/images/info-off.png",
                logonIcon: "/static/tethys_gizmos/images/info-on.png",
            ...
            addIcon('clear', options.clearIcon, 'Remove all primitives', function() {
                ...
                _self.executeListeners({name: 'clearData'});
            });
            addIcon('draw_helper_log_status', options.logoffIcon, 'Turn on/off logging', function() {
                var log_div = document.getElementById('cesium_map_view_logging');
                var draw_helper_img_src = document.getElementById('draw_helper_log_status').getElementsByTagName("img")[0];
                if (log_div.style.display === 'none') {
                    log_div.style.display = 'block';
                    draw_helper_img_src.src = options.logonIcon;
                }
                else {
                    draw_helper_img_src.src = options.logoffIcon;
