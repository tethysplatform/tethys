...
class GoogleMapView(TethysGizmoOptions):
    ...
    Attributes:
        ...
        maps_api_key(string, required): The Google Maps API key. If the API key is provided in the portal.yml via the TETHYS_GIZMOS_GOOGLE_MAPS_API_KEY option, this parameter is not required.
