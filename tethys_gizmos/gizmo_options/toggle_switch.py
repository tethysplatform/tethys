...
class ToggleSwitch(TethysGizmoOptions):
    ...
    def get_vendor_js(cls):
        ...
        """
        return dependencies['bootstrap-switch'].get_custom_version_url(url_type='js', version=cls.version),
    ...
    def get_vendor_css(cls):
        ...
        {% block styles %} block
        """
        return dependencies['bootstrap-switch'].get_custom_version_url(url_type='css', version=cls.version),
