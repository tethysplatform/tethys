...
class CesiumMapView(TethysGizmoOptions):
    ...
    Attributes:
        cesium_ion_token(str): Cesium Ion Access Token. See: `Cesium Rest API - Authentication <https://cesium.com/learn/ion/ion-upload-rest/#authentication>`_.
    ...
    **Cesium Ion Token**
    ...
    This is your Cesium Ion Access token that grants you access to the Cesium REST APIs. In newer version of Cesium this token is required for proper functioning of the map viewer. To learn how to obtain a token, see `Cesium REST API - Authentication <https://cesium.com/learn/ion/ion-upload-rest/#authentication>`_.
