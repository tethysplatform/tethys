...
SocialAuthExceptionMiddleware = optional_import(
    "SocialAuthExceptionMiddleware", from_module="social_django.middleware"
)
social_exceptions = optional_import("exceptions", from_module="social_core")
TokenAuthentication = optional_import(
    "TokenAuthentication", from_module="rest_framework.authentication"
)
