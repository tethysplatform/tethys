...
def handler_400(request, exception, *args, **kwargs):
    ...
    context = {'error_code': '400',
               ...
               'error_message': _("Sorry, but we can't process your request. Try something different."),
...
def handler_403(request, exception, *args, **kwargs):
    ...
    context = {'error_code': '403',
               'error_title': _('Sorry, you are unable to access this page right now.'),
...
def handler_404(request, exception, error_message=None, *args, **kwargs):
    ...
    if not error_message:
        error_message = _("We are unable to find the page you requested. Please, check the address and try again.")
...
def handler_500(request):
    ...
    context = {'error_code': '500',
               ...
               'error_message': _("We're sorry, but we seem to have a problem. Please, come back later and try again."),
               'error_image': '/static/tethys_portal/images/error_500.png'}
