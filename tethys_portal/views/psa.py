...
do_auth, do_complete = optional_import(
    ("do_auth", "do_complete"), from_module="social_core.actions"
)
psa = optional_import("psa", from_module="social_django.utils")
_do_login = optional_import("_do_login", from_module="social_django.views")
