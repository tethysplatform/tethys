...
class StaticDependency:
    ...
    def __init__(self, npm_name, version, css_path=None, js_path=None, css_integrity=None, js_integrity=None,
                 js_paths=None, debug_path_converter=None, cdn_url=None):
        ...
        self.debug_path_converter = debug_path_converter or self.default_debug_path_converter
...
vendor_static_dependencies = {
    ...
    'd3-tip': JsDelivrStaticDependency(
        npm_name='d3-v6-tip',
        version='1.0.9',
        js_path='build/d3-v6-tip.min.js'
    ),
    'dagre': JsDelivrStaticDependency(
        npm_name='dagre',
        version='0.8.5',
        js_path='dist/dagre.core.min.js'
    ),
