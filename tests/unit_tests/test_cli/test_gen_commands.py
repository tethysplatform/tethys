...
from tethys_cli.gen_commands import (
    get_environment_value, get_settings_value, generate_command,
    GEN_SETTINGS_OPTION, GEN_NGINX_OPTION, GEN_UWSGI_SERVICE_OPTION, GEN_UWSGI_SETTINGS_OPTION,
)
...
class CLIGenCommandsTest(unittest.TestCase):
    ...
    @mock.patch('tethys_cli.gen_commands.get_environment_value')
    @mock.patch('tethys_cli.gen_commands.os.path.isfile')
    def test_generate_command_uwsgi_settings_option_bad_directory(self, mock_os_path_isfile, mock_env,
    ...
    @mock.patch('tethys_cli.gen_commands.get_environment_value')
    @mock.patch('tethys_cli.gen_commands.os.path.isfile')
    def test_generate_command_uwsgi_settings_pre_existing_input_exit(self, mock_os_path_isfile, mock_env,
