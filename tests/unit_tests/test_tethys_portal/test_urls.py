...
class TestUrls(TethysTestCase):
    ...
    def test_account_urls_account_login(self):
        ...
        self.assertEqual(f"{prefix_to_path}/accounts/login/", url)
    ...
    def test_account_urls_accounts_logout(self):
        ...
        resolver = resolve(url)
        self.assertEqual(f"{prefix_to_path}/accounts/logout/", url)
    ...
    def test_account_urls_accounts_register(self):
        ...
        resolver = resolve(url)
        self.assertEqual(f"{prefix_to_path}/accounts/register/", url)
    ...
    def test_account_urls_accounts_password_reset(self):
        ...
        resolver = resolve(url)
        self.assertEqual(f"{prefix_to_path}/accounts/password/reset/", url)
    ...
    def test_account_urls_accounts_password_reset_done(self):
        ...
        resolver = resolve(url)
        self.assertEqual(f"{prefix_to_path}/accounts/password/reset/done/", url)
    ...
    def test_account_urls_accounts_password_confirm(self):
        ...
        resolver = resolve(url)
        self.assertEqual(f"{prefix_to_path}/accounts/password/reset/f00Bar-tok/", url)
    ...
    def test_account_urls_accounts_password_done(self):
        ...
        resolver = resolve(url)
        self.assertEqual(f"{prefix_to_path}/accounts/password/done/", url)
    ...
    def test_oauth2_urls_login(self):
        ...
        resolver = resolve(url)
        self.assertEqual(f"{prefix_to_path}/oauth2/login/foo/", url)
    ...
    def test_oauth2_urls_complete(self):
        ...
        resolver = resolve(url)
        self.assertEqual(f"{prefix_to_path}/oauth2/complete/foo/", url)
    ...
    def test_oauth2_urls_disconnect(self):
        ...
        resolver = resolve(url)
        self.assertEqual(f"{prefix_to_path}/oauth2/disconnect/foo/", url)
    ...
    def test_oauth2_urls_disconnect_individual(self):
        ...
        resolver = resolve(url)
        self.assertEqual(f"{prefix_to_path}/oauth2/disconnect/foo/123/", url)
        self.assertEqual("disconnect", resolver.func.__name__)
        self.assertEqual("social_django.views", resolver.func.__module__)
    ...
    def test_oauth2_urls_tenant(self):
        ...
        resolver = resolve(url)
        self.assertEqual(f"{prefix_to_path}/oauth2/tenant/foo/", url)
    ...
    def test_user_urls_profile(self):
        ...
        self.assertEqual(f"{prefix_to_path}/user/", url)
    ...
    def test_user_urls_settings(self):
        ...
        resolver = resolve(url)
        self.assertEqual(f"{prefix_to_path}/user/settings/", url)
    ...
    def test_user_urls_change_password(self):
        ...
        resolver = resolve(url)
        self.assertEqual(f"{prefix_to_path}/user/change-password/", url)
    ...
    def test_user_urls_delete(self):
        ...
        resolver = resolve(url)
        self.assertEqual(f"{prefix_to_path}/user/delete-account/", url)
    ...
    def test_urlpatterns_handoff_capabilities(self):
        ...
        resolver = resolve(url)
        self.assertEqual(f"{prefix_to_path}/handoff/foo/", url)
    ...
    def test_urlpatterns_handoff(self):
        ...
        resolver = resolve(url)
        self.assertEqual(f"{prefix_to_path}/handoff/foo/Bar/", url)
    ...
    def test_urlpatterns_update_job_status(self):
        ...
        resolver = resolve(url)
        self.assertEqual(f"{prefix_to_path}/update-job-status/JI001/", url)
    ...
    def test_urlpatterns_update_dask_job_status(self):
        ...
        resolver = resolve(url)
        self.assertEqual(f"{prefix_to_path}/update-dask-job-status/123456789/", url)
