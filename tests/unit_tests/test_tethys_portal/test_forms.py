...
class TethysPortalFormsTests(TestCase):
    ...
    def test_LoginForm_no_captcha(self):
        ...
        with self.settings(NO_CAPTCHA=True):
    ...
    def test_LoginForm_simple_captcha(self):
        ...
        with self.settings(NO_CAPTCHA=False, RECAPTCHA_PRIVATE_KEY='', RECAPTCHA_PUBLIC_KEY=''):
            reload(tethys_portal.forms)
            login_form = tethys_portal.forms.LoginForm(login_data)
            self.assertTrue(login_form.is_valid())
    ...
    def test_LoginForm_recaptcha(self):
        ...
        with self.settings(NO_CAPTCHA=False, RECAPTCHA_PRIVATE_KEY='my-fake-private-key',
