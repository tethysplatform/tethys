...
from tethys_portal.views.user import settings
from tethys_portal.middleware import (
...
class TethysPortalMiddlewareTests(unittest.TestCase):
    ...
    @mock.patch("tethys_portal.middleware.hasattr")
    @mock.patch("tethys_portal.middleware.redirect")
    def test_process_exception_isinstance_google(
        self,
        mock_redirect,
        mock_hasattr,
        mock_isinstance,
        ...
        self.assertEqual(
            "The Google account you tried to connect to has already been associated with another "
            "account.",
            call_args[0][0][1],
        )
    ...
    @mock.patch("tethys_portal.middleware.hasattr")
    @mock.patch("tethys_portal.middleware.redirect")
    def test_process_exception_isinstance_linkedin(
        self,
        mock_redirect,
        mock_hasattr,
        mock_isinstance,
    ...
    @mock.patch("tethys_portal.middleware.hasattr")
    @mock.patch("tethys_portal.middleware.redirect")
    def test_process_exception_isinstance_hydroshare(
        self,
        mock_redirect,
        mock_hasattr,
        mock_isinstance,
        ...
        self.assertEqual(
            "The HydroShare account you tried to connect to has already been associated with "
            "another account.",
            call_args[0][0][1],
        )
    ...
    @mock.patch("tethys_portal.middleware.hasattr")
    @mock.patch("tethys_portal.middleware.redirect")
    def test_process_exception_isinstance_facebook(
        self,
        mock_redirect,
        mock_hasattr,
        mock_isinstance,
        ...
        self.assertEqual(
            "The Facebook account you tried to connect to has already been associated with "
            "another account.",
            call_args[0][0][1],
        )
    ...
    @mock.patch("tethys_portal.middleware.hasattr")
    @mock.patch("tethys_portal.middleware.redirect")
    def test_process_exception_isinstance_social(
        self,
        mock_redirect,
        mock_hasattr,
        mock_isinstance,
        ...
        self.assertEqual(
            "The social account you tried to connect to has already been associated with "
            "another account.",
            call_args[0][0][1],
        )
    ...
    def test_process_exception_isinstance_exception_with_anonymous_user(
        ...
        self.assertEqual(
            "Unable to disconnect from this social account.", call_args[0][0][1]
        )
    ...
    def test_app_access_disabled(self, mock_app, mock_404):
        ...
        self.assertEqual(
            mock_404.call_args_list[0][0][2],
            "This app is disabled. A user with admin permissions can "
    ...
    def mock_request_with_user(path="/apps", with_sso=False, is_staff=False):
        ...
        mock_request.user.social_auth.count = mock.MagicMock(
            return_value=1 if with_sso else 0
        )
        return mock_request
    ...
    def test_mfa_required_all_true__normal_user(
    ...
    @mock.patch("tethys_portal.middleware.has_mfa")
    @mock.patch("tethys_portal.middleware.settings")
    def test_mfa_required_all_true__sso_user(
        self, mock_settings, mock_has_mfa, mock_redirect
    ):
        mock_settings.MFA_REQUIRED = True
        mock_settings.SSO_MFA_REQUIRED = True
    ...
    @mock.patch("tethys_portal.middleware.has_mfa")
    @mock.patch("tethys_portal.middleware.settings")
    def test_mfa_required_all_true__staff_user(
        self, mock_settings, mock_has_mfa, mock_redirect
    ):
        mock_settings.MFA_REQUIRED = True
        mock_settings.SSO_MFA_REQUIRED = True
    ...
    @mock.patch("tethys_portal.middleware.has_mfa")
    @mock.patch("tethys_portal.middleware.settings")
    def test_mfa_required__all_false__normal_user(
        self, mock_settings, mock_has_mfa, mock_redirect
    ):
    ...
    @mock.patch("tethys_portal.middleware.has_mfa")
    @mock.patch("tethys_portal.middleware.settings")
    def test_mfa_required__all_false__sso_user(
        self, mock_settings, mock_has_mfa, mock_redirect
    ):
        mock_settings.MFA_REQUIRED = False
        mock_settings.SSO_MFA_REQUIRED = False
    ...
    @mock.patch("tethys_portal.middleware.has_mfa")
    @mock.patch("tethys_portal.middleware.settings")
    def test_mfa_required__all_false__staff_user(
        self, mock_settings, mock_has_mfa, mock_redirect
    ):
        mock_settings.MFA_REQUIRED = False
        mock_settings.SSO_MFA_REQUIRED = False
    ...
    @mock.patch("tethys_portal.middleware.has_mfa")
    @mock.patch("tethys_portal.middleware.settings")
    def test_mfa_required__mfa_required_false__normal_user(
        self, mock_settings, mock_has_mfa, mock_redirect
    ):
        mock_settings.MFA_REQUIRED = False
        mock_settings.SSO_MFA_REQUIRED = True
    ...
    @mock.patch("tethys_portal.middleware.has_mfa")
    @mock.patch("tethys_portal.middleware.settings")
    def test_mfa_required__mfa_required_false__sso_user(
        self, mock_settings, mock_has_mfa, mock_redirect
    ):
        mock_settings.MFA_REQUIRED = False
        mock_settings.SSO_MFA_REQUIRED = True
    ...
    @mock.patch("tethys_portal.middleware.has_mfa")
    @mock.patch("tethys_portal.middleware.settings")
    def test_mfa_required__mfa_required_false__staff_user(
        self, mock_settings, mock_has_mfa, mock_redirect
    ):
        mock_settings.MFA_REQUIRED = False
        mock_settings.SSO_MFA_REQUIRED = True
    ...
    @mock.patch("tethys_portal.middleware.has_mfa")
    @mock.patch("tethys_portal.middleware.settings")
    def test_mfa_required__sso_mfa_required_false__normal_user(
        self, mock_settings, mock_has_mfa, mock_redirect
    ):
        mock_settings.MFA_REQUIRED = True
        mock_settings.SSO_MFA_REQUIRED = False
    ...
    @mock.patch("tethys_portal.middleware.has_mfa")
    @mock.patch("tethys_portal.middleware.settings")
    def test_mfa_required__sso_mfa_required_false__sso_user(
        self, mock_settings, mock_has_mfa, mock_redirect
    ):
        mock_settings.MFA_REQUIRED = True
        mock_settings.SSO_MFA_REQUIRED = False
    ...
    @mock.patch("tethys_portal.middleware.has_mfa")
    @mock.patch("tethys_portal.middleware.settings")
    def test_mfa_required__sso_mfa_required_false__staff_user(
        self, mock_settings, mock_has_mfa, mock_redirect
    ):
        mock_settings.MFA_REQUIRED = True
        mock_settings.SSO_MFA_REQUIRED = False
    ...
    @mock.patch("tethys_portal.middleware.has_mfa")
    @mock.patch("tethys_portal.middleware.settings")
    def test_mfa_required__admin_mfa_required_false__normal_user(
        self, mock_settings, mock_has_mfa, mock_redirect
    ):
        mock_settings.MFA_REQUIRED = True
        mock_settings.SSO_MFA_REQUIRED = True
    ...
    @mock.patch("tethys_portal.middleware.has_mfa")
    @mock.patch("tethys_portal.middleware.settings")
    def test_mfa_required_excluded_paths(
        self, mock_settings, mock_has_mfa, mock_redirect
    ):
        mock_settings.MFA_REQUIRED = True
        mock_settings.SSO_MFA_REQUIRED = True
    ...
    @mock.patch("tethys_portal.middleware.has_mfa")
    @mock.patch("tethys_portal.middleware.settings")
    def test_mfa_required_all_true__valid_token__normal_user(
    ...
    @mock.patch("tethys_portal.middleware.has_mfa")
    @mock.patch("tethys_portal.middleware.settings")
    def test_mfa_required_all_true__valid_token__sso_user(
        self, mock_settings, mock_has_mfa, mock_redirect, _
    ):
        mock_settings.MFA_REQUIRED = True
        mock_settings.SSO_MFA_REQUIRED = True
    ...
    @mock.patch("tethys_portal.middleware.has_mfa")
    @mock.patch("tethys_portal.middleware.settings")
    def test_mfa_required_all_true__invalid_token__normal_user(
        self, mock_settings, mock_has_mfa, mock_redirect, mock_authenticate
    ):
        mock_settings.MFA_REQUIRED = True
        mock_settings.SSO_MFA_REQUIRED = True
        mock_settings.ADMIN_MFA_REQUIRED = True
    ...
    @mock.patch("tethys_portal.middleware.has_mfa")
    @mock.patch("tethys_portal.middleware.settings")
    def test_mfa_required_all_true__invalid_token__sso_user(
        self, mock_settings, mock_has_mfa, mock_redirect, mock_authenticate
    ):
        mock_settings.MFA_REQUIRED = True
        mock_settings.SSO_MFA_REQUIRED = True
    ...
    def test_oauth_required_has_provider(self, mock_settings, mock_gap):
        ...
        TethysOauthRequiredMiddleware(mock_get_response)(mock_request)
        mock_get_response.assert_called_once_with(mock_request)
        mock_request.user.social_auth.filter.assert_called_once_with(provider="test_value")
    ...
    @mock.patch("tethys_portal.middleware.get_active_app")
    @mock.patch("tethys_portal.middleware.settings")
    def test_oauth_required_no_provider(self, mock_settings, mock_gap, mock_redirect, mock_messages, mock_reverse, mock_urlencode):
        mock_get_response = mock.MagicMock()
        ...
        mock_redirect.assert_called_once_with(f"{mock_reverse.return_value}?next=/apps/test_package/test_path")