...
class TestMapLayout(TestCase):
    ...
    def test__build_map_view(self):
        ...
        self.assertListEqual(ret['controls'][2]['ZoomToExtent']['extent'], [-10, -10, 10, 10])
    ...
    def test_build_legend_item(self):
        ...
        self.assertDictEqual(ret_json, {
            ...
            'div_id': 'this-one',
            'division_string':
                'v3:0.00;c3:#fff100;v4:1.67;c4:#ff8c00;v5:3.33;c5:#e81123;v6:5.00;c6:#ec008c;v7:6.67;'
    ...
    def test_build_layer_tree_item_create(self):
        ...
        self.assertDictEqual(ret_json, {
            'response':
                '<li id="12345" class="layer-group-item">\n'
                '  \n'
    ...
    def test_convert_geojson_to_shapefile_Polygon(self):
        ...
        self.assertEqual(ret['Content-Disposition'], 'attachment; filename="12345_Polygon.zip"')

        with tempfile.TemporaryFile() as tf:
            tf.write(ret.content)

            with zipfile.ZipFile(tf) as z:
                self.assertListEqual(z.namelist(), [
                    '12345_Polygon.prj',
                    '12345_Polygon.shp',
                    '12345_Polygon.dbf',
                    '12345_Polygon.shx',
    ...
    def test_convert_geojson_to_shapefile_Point(self):
        ...
        self.assertEqual(ret.status_code, 200)
        self.assertEqual(ret['Content-Type'], 'application/zip')
        self.assertEqual(ret['Content-Disposition'], 'attachment; filename="12345_Point.zip"')
    ...
    def test_convert_geojson_to_shapefile_LineString(self):
        ...
        self.assertEqual(ret.status_code, 200)
        self.assertEqual(ret['Content-Type'], 'application/zip')
        self.assertEqual(ret['Content-Disposition'], 'attachment; filename="12345_LineString.zip"')
