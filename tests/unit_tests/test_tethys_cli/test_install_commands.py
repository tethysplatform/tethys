...
class TestInstallCommands(TestCase):
    ...
    def test_conda_and_pip_package_install(
        ...
        self.assertEqual([sys.executable, "-m", "pip", "install", "see"], mock_call.mock_calls[0][1][0])
        self.assertEqual([sys.executable, "-m", "pip", "install", "."], mock_call.mock_calls[1][1][0])
    ...
    def test_conda_install_no_conda_proceed(
        ...
        self.assertEqual([sys.executable, "-m", "pip", "install", "geojson"], mock_call.mock_calls[0][1][0])
        self.assertEqual([sys.executable, "-m", "pip", "install", "see"], mock_call.mock_calls[1][1][0])
        self.assertEqual([sys.executable, "-m", "pip", "install", "."], mock_call.mock_calls[2][1][0])
    ...
    def test_without_dependencies(
        ...
        self.assertEqual([sys.executable, "-m", "pip", "install", "."], mock_call.mock_calls[0][1][0])
