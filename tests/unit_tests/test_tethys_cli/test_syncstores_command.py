...
class SyncstoresCommandTests(unittest.TestCase):
    ...
    def test_syncstores_command_no_args(
        ...
        mock_subprocess_call.assert_called_with(
            [sys.executable, "/foo/manage.py", "syncstores"]
        )

    @mock.patch("tethys_cli.syncstores_command.subprocess.call")
    @mock.patch("tethys_cli.syncstores_command.get_manage_path")
    def test_syncstores_command_args_no_refresh(
        self, mock_get_manage_path, mock_subprocess_call
    ):
        mock_args = mock.MagicMock()
        mock_args.refresh = False
    ...
    @mock.patch("tethys_cli.syncstores_command.subprocess.call")
    @mock.patch("tethys_cli.syncstores_command.get_manage_path")
    def test_syncstores_command_no_args_assert(
        self, mock_get_manage_path, mock_subprocess_call
    ):
        mock_args = mock.MagicMock()
        mock_args.refresh = False
    ...
    @mock.patch("tethys_cli.syncstores_command.subprocess.call")
    @mock.patch("tethys_cli.syncstores_command.get_manage_path")
    def test_syncstores_command_refresh_continue(
        self, mock_get_manage_path, mock_subprocess_call, mock_input
    ):
        mock_args = mock.MagicMock()
        ...
        mock_subprocess_call.assert_called_once()
        mock_subprocess_call.assert_called_with(
            [sys.executable, "/foo/manage.py", "syncstores", "-r", "foo_app"]
        )
    ...
    @mock.patch("tethys_cli.syncstores_command.subprocess.call")
    @mock.patch("tethys_cli.syncstores_command.get_manage_path")
    def test_syncstores_command_refresh_exit(
        self,
