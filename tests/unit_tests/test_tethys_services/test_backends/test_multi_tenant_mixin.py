...
class MultiTenantMixinTests(test.SimpleTestCase):
    def setUp(self):
        ...
        self.test_secret = (
            "032f86d0f5f367171fd6270f7f5fa383fa27604fake9c5f1a0a5d5d2b4227ace"
        )
    ...
    def test_tenant_setter_improperly_configured(self):
        ...
        self.assertEqual(
            'Backend "test-mtm" not configured for multi-tenant: '
    ...
    def test_tenant_setter_value_error(self):
        ...
        self.assertEqual(
            'Tenant "foo bar" not found in SOCIAL_AUTH_TEST_MTM_MULTI_TENANT.',
            str(cm.exception),
        )
    ...
    @mock.patch(
        "tethys_services.backends.multi_tenant_mixin.MultiTenantMixin.tenant_settings",
