...
class SecureMapServiceTests(TethysTestCase):
    ...
    def test_get_oauth_token_user_not_linked(self):
        ...
        self.assertEqual(
            str(context.exception), 
            "User not linked to test_provider."
        )
    ...
    def test_get_resolved_params_with_api_key(self):
        secure_map_service = SecureMapService(
            ...
            endpoint="http://example.com",
            authentication_method="api_key",
            params={"param1": "value1", "param2": "value2", "test_api_key": "${api_key}"},
            api_key="api_key_12345"
        )

        resolved_params = secure_map_service.get_resolved_params()
        self.assertEqual(resolved_params, {"param1": "value1", "param2": "value2", "test_api_key": "api_key_12345"})
    ...
    def test_get_resolved_params_with_missing_api_key(self):
        ...
        resolved_params = secure_map_service.get_resolved_params()
        self.assertEqual(resolved_params, {"param1": "value1", "param2": "value2", "test_api_key": ""})
    ...
    def test_get_resolved_params_with_multiple_params(self):
        secure_map_service = SecureMapService(
            ...
            endpoint="http://example.com",
            authentication_method="api_key",
            params={"param1": "value1", "name": "${name}", "test_api_key": "${api_key}"},
            api_key="api_key_12345"
        )
    
        resolved_params = secure_map_service.get_resolved_params()
        self.assertEqual(resolved_params, {"param1": "value1", "name": "test_secure_map_service", "test_api_key": "api_key_12345"})