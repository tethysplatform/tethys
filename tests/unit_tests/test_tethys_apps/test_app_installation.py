...
class TestAppInstallation(unittest.TestCase):
    def setUp(self):
        ...
        self.rel_path = Path('tests') / 'apps' / 'tethysapp-test_app' / 'tethysapp' / 'test_app' / 'public'
    ...
    def test_find_resource_files_of_type(self):
        ...
        ret = tethys_app_installation.find_resource_files_of_type('public', 'test_app', app_root)
        self.check_paths(ret)
    ...
    def test_find_all_resource_files(self, mock_find_type):
        package = 'package'
        app_root = 'app_root'
        tethys_app_installation.find_all_resource_files(app_package=package, app_root=app_root)
        self.assertEqual(
            [
