...
class UninstallCommandTests(unittest.TestCase):
    ...
    def test_uninstall_command(self, mock_get_manage_path, mock_subprocess_call):
        ...
        mock_subprocess_call.assert_called_with(['python', '/foo/manage.py', 'tethys_app_uninstall', 'foo_ext', '-e'])
    ...
    def test_uninstall_command_no_extension(self, mock_get_manage_path, mock_subprocess_call):
        ...
        mock_get_manage_path.assert_called_once()
        mock_subprocess_call.assert_called_once()
        mock_subprocess_call.assert_called_with(['python', '/foo/manage.py', 'tethys_app_uninstall', 'foo_app'])
