...
class TestDockerCommands(unittest.TestCase):
    def setUp(self):
        ...
        dc_patcher = mock.patch('tethys_apps.cli.docker_commands.docker.from_env', return_value=self.mock_dc)
        self.mock_from_env = dc_patcher.start()
        self.addCleanup(dc_patcher.stop)
        input_patcher = mock.patch('tethys_apps.cli.docker_commands.input', return_value=mock.MagicMock(name='input'))
    ...
    @mock.patch('tethys_apps.cli.docker_commands.ContainerMetadata.is_installed', new_callable=mock.PropertyMock)
    ...
    @mock.patch('tethys_apps.cli.docker_commands.ContainerMetadata.container', new_callable=mock.PropertyMock)
    ...
    @mock.patch('tethys_apps.cli.docker_commands.GeoServerContainerMetadata.is_cluster', new_callable=mock.PropertyMock)
    ...
    @mock.patch('tethys_apps.cli.docker_commands.ContainerMetadata.port_bindings', new_callable=mock.PropertyMock)
    ...
    @mock.patch('tethys_apps.cli.docker_commands.write_pretty_output')
    @mock.patch('tethys_apps.cli.docker_commands.UserInputHelper.get_verified_password')
    @mock.patch('tethys_apps.cli.docker_commands.PostGisContainerMetadata.default_container_options')
    ...
    @mock.patch('tethys_apps.cli.docker_commands.GeoServerContainerMetadata.port_bindings',
    ...
    @mock.patch('tethys_apps.cli.docker_commands.Mount')
    @mock.patch('tethys_apps.cli.docker_commands.write_pretty_output')
    @mock.patch('tethys_apps.cli.docker_commands.UserInputHelper.get_valid_numeric_input')
    @mock.patch('tethys_apps.cli.docker_commands.UserInputHelper.get_valid_choice_input')
    @mock.patch('tethys_apps.cli.docker_commands.UserInputHelper.get_valid_directory_input')
    @mock.patch('tethys_apps.cli.docker_commands.GeoServerContainerMetadata.default_container_options')
    @mock.patch('tethys_apps.cli.docker_commands.GeoServerContainerMetadata.is_cluster', new_callable=mock.PropertyMock)
    ...
    @mock.patch('tethys_apps.cli.docker_commands.write_pretty_output')
    @mock.patch('tethys_apps.cli.docker_commands.UserInputHelper.get_verified_password')
    @mock.patch('tethys_apps.cli.docker_commands.UserInputHelper.get_input_with_default')
    @mock.patch('tethys_apps.cli.docker_commands.ContainerMetadata.default_container_options')
    ...
    @mock.patch('tethys_apps.cli.docker_commands.PostGisContainerMetadata.image', new_callable=mock.PropertyMock)
    ...
    @mock.patch('tethys_apps.cli.docker_commands.write_pretty_output')
    @mock.patch('tethys_apps.cli.docker_commands.PostGisContainerMetadata.get_container_options')
    ...
    @mock.patch('tethys_apps.cli.docker_commands.ContainerMetadata.get_containers')
    ...
    @mock.patch('tethys_apps.cli.docker_commands.pull_docker_images')
    @mock.patch('tethys_apps.cli.docker_commands.ContainerMetadata.get_containers')
    ...
    @mock.patch('tethys_apps.cli.docker_commands.write_pretty_output')
    @mock.patch('tethys_apps.cli.docker_commands.get_docker_container_statuses')
    ...
    @mock.patch('tethys_apps.cli.docker_commands.getpass')
    ...
    def test_uih_get_valid_directory_input_oserror(self, mock_os_path_isdir, mock_os_makedirs, mock_pretty_output):
        ...
        self.assertEquals('prompt [/tmp]: ', input_call_args[0][0][0])
        self.assertEquals('Please provide a valid directory\nprompt [/tmp]: ', input_call_args[1][0][0])
