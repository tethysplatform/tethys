...
from tethys_quotas import helpers


class TethysQuotasHelpersTest(TestCase):
    ...
    @mock.patch('tethys_quotas.helpers.settings', RESOURCE_QUOTA_HANDLERS=['my'])
    @mock.patch('tethys_quotas.helpers.log')
    def test_bad_rq_handler(self, mock_log, _):
        helpers.sync_resource_quota_handlers()
        mock_log.warning.assert_called()

    @mock.patch('tethys_quotas.helpers.settings', RESOURCE_QUOTA_HANDLERS=[
    ...
    @mock.patch('tethys_quotas.helpers.settings', RESOURCE_QUOTA_HANDLERS=['not.subclass.of.rq'])
    @mock.patch('tethys_quotas.helpers.log')
    ...
    def test_passes_quota_passes(self, mock_rq):
        ...
        self.assertTrue(helpers.passes_quota(UserQuota, 'codename'))
    ...
    def test_passes_quota_fails(self, mock_rq):
        ...
        self.assertFalse(helpers.passes_quota(UserQuota, 'codename'))

    @mock.patch('tethys_quotas.helpers.get_quota')
    @mock.patch('tethys_quotas.models.ResourceQuota')
    def test_get_resource_available_user(self, mock_rq, mock_get_quota):
        ...
        ret = helpers.get_resource_available(User(), 'codename')
    ...
    def test_get_resource_available_app(self, mock_rq, mock_get_quota):
        ...
        ret = helpers.get_resource_available(TethysApp(), 'codename')
    ...
    def test_get_resource_available_rq_dne(self, mock_rq, mock_log):
        ...
        ret = helpers.get_resource_available(mock.MagicMock(), 'codename')
    ...
    def test_get_quota_rq_inactive(self, mock_rq):
        ...
        ret = helpers.get_quota(mock.MagicMock(), 'codename')
    ...
    def test_get_quota_bad_entity(self, mock_rq):
        ...
        with self.assertRaises(ValueError) as context:
            helpers.get_quota(mock.MagicMock(), 'codename')
        self.assertTrue(
    ...
    def test_get_quota_aq(self, mock_rq, mock_aq):
        ...
        ret = helpers.get_quota(TethysApp(), 'codename')
    ...
    def test_get_quota_staff(self, mock_rq):
        ...
        ret = helpers.get_quota(user, 'codename')
        self.assertEquals(None, ret['quota'])
