...
def add_app_settings_parser(subparsers):
    ...
    app_settings_subparsers = app_settings_parser.add_subparsers(title='Options', dest='app_setting sub-command.')
    app_settings_subparsers.required = True
