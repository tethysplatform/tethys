...
def add_db_parser(subparsers):
    ...
    db_parser = subparsers.add_parser(
        "db",
        help="Tethys Database Server utility commands.",
    ...
    db_parser.add_argument(
        "-p", "--password", dest="password", help="Password for the database user."
    )
    db_parser.add_argument(
        "-N",
        "--superuser-name",
    ...
    db_parser.add_argument(
        "-P",
        "--superuser-password",
        dest="superuser_password",
        help="Password for the database super user.",
    )
    db_parser.add_argument(
        "--portal-superuser-name",
        "--pn",
        dest="portal_superuser_name",
        help="Name for the Tethys portal super user.",
    )
    db_parser.add_argument(
        "--portal-superuser-email",
        "--email",
        "--pe",
        dest="portal_superuser_email",
        help="Email of the Tethys portal super user.",
    )
    db_parser.add_argument(
        "--portal-superuser-password",
        "--pp",
        dest="portal_superuser_password",
    ...
    **kwargs,
    ...
    try:
        User.objects.create_superuser(
            portal_superuser_name, portal_superuser_email, portal_superuser_password
        )
    ...
    if err_code:
        response = (
            ...
            if kwargs["no_confirmation"]
                ...
                f"There was an error with the {fn.__name__} step of the database configuration.\n"
