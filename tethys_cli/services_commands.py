...
def services_create_persistent_command(args, unknown_args=""):
    """
...
def services_create_wps_command(args, unknown_args=""):
    """
...
def services_remove_spatial_command(args, unknown_args=""):
    remove_service('spatial', args)


def services_remove_dataset_command(args, unknown_args=""):
    remove_service('dataset', args)


def services_remove_persistent_command(args, unknown_args=""):
    remove_service('persistent', args)


def services_remove_wps_command(args, unknown_args=""):
    remove_service('wps', args)


def services_list_command(args, unknown_args=""):
    """
    Interact with Tethys Services (Spatial/Persistent Stores) to create them and/or link them to existing apps
    """
    load_apps()
