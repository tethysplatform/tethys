# Generated by Django 3.2.12 on 2022-08-12 16:42
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('extended_properties', models.JSONField(blank=True, default=dict, null=True)),
                ('_process_results_function', models.CharField(blank=True, max_length=1024, null=True)),
                ('_status', models.CharField(choices=[('PEN', 'Pending'), ('SUB', 'Submitted'), ('RUN', 'Running'), ('VAR', 'Various'), ('PAS', 'Paused'), ('COM', 'Complete'), ('ERR', 'Error'), ('ABT', 'Aborted'), ('VCP', 'Various-Complete'), ('RES', 'Results-Ready'), ('OTH', 'Other')], default='PEN', max_length=3)),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
                ('groups', models.ManyToManyField(blank=True, related_name='tethys_jobs', to='auth.Group', verbose_name='groups')),
                ('status_message', models.CharField(blank=True, max_length=2048, null=True)),
            ],
            options={
                'verbose_name': 'Job',
            },
